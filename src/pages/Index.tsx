...
import { Calendar, Users, LogOut, Bell, Shield } from 'lucide-react';
    ...
    <div className="h-screen w-full bg-background text-foreground overflow-auto">
      <div className="container mx-auto px-4 py-6">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
          <TabsList className={`grid w-full ${canAccessUserManagement() ? 'grid-cols-4' : 'grid-cols-2'} bg-muted border border-border`}>
            <TabsTrigger
              value="tasks"
            ...
            {canAccessUserManagement() && (
              <>
                ...
                >
                  ...
                  <span className="sm:hidden">Núcleos</span>
                </TabsTrigger>
              </>
            )}
          </TabsList>
